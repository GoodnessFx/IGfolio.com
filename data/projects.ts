...
export const websiteProjects: Project[] = [
  ...
  {
    name: "Vibe District",
    gradient: "linear-gradient(135deg, #3c1f2d 0%, #14080e 100%)",
    desc: "Premium streetwear e-commerce website built to showcase products, streamline ordering, and deliver a stronger branded online shopping experience.",
    tags: ["React", "TypeScript", "Vite", "Tailwind CSS"],
    githubUrl: "https://github.com/GoodnessFx/Vibe-District",
    liveUrl: "https://vibe-district.vercel.app/",
    section: "website",
  },
  {
    name: "DABZ Global",
    gradient: "linear-gradient(135deg, #d9d9d9 0%, #6b7280 100%)",
    desc: "Conversion-focused gadget storefront built for product discovery, cart flow, and WhatsApp-first ordering for a live retail business.",
    tags: ["React", "Vite", "Tailwind CSS", "WhatsApp Commerce"],
    githubUrl: "https://github.com/GoodnessFx/DABZ-GLOBAL",
    liveUrl: "https://dabz-global.vercel.app/",
    section: "website",
  },
  {
    name: "ChainCodeCamp",
    gradient: "linear-gradient(135deg, #0f172a 0%, #020617 100%)",
    desc: "Interactive educational website designed to teach smart contract development through a polished curriculum, glossary, and learning workflow.",
    tags: ["HTML", "JavaScript", "Vercel", "Interactive Learning"],
    githubUrl: "https://github.com/GoodnessFx/ChainCodeCamp",
    liveUrl: "https://chain-code-camp.vercel.app/",
    section: "website",
  },
  {
    name: "Mercy's Kitchen",
    gradient: "linear-gradient(135deg, #6b3e26 0%, #20110a 100%)",
    desc: "Food ordering and catering website built around menu browsing, responsive presentation, and direct WhatsApp enquiry conversion.",
    tags: ["React", "TypeScript", "Vite", "Tailwind CSS"],
    githubUrl: "https://github.com/GoodnessFx/Mercy-s-Kitchen",
    liveUrl: "https://mercy-s-kitchen.vercel.app/",
    section: "website",
  },
  {
    name: "Aura by Temi",
    gradient: "linear-gradient(135deg, #b47a8f 0%, #321923 100%)",
    desc: "Luxury beauty brand website built for bookings, gallery presentation, and a smoother WhatsApp-led conversion flow.",
    tags: ["React", "TypeScript", "Vite", "Tailwind CSS"],
    githubUrl: "https://github.com/GoodnessFx/Aura-by-Temi",
    liveUrl: "https://aura-by-temi.vercel.app/",
    section: "website",
  },
  {
    name: "Professor R.I.S Agbede Foundation",
    gradient: "linear-gradient(135deg, #0f4c5c 0%, #06232a 100%)",
    desc: "Foundation website created to present mission, programmes, impact, and donation pathways with a professional nonprofit experience.",
    tags: ["React", "TypeScript", "Vite", "Tailwind CSS"],
